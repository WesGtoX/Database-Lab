...
CREATE OR REPLACE PROCEDURE cadcli(vnome IN CLIENTE.nom_cliente%TYPE, 
    vdtnasc IN CLIENTE.dtn_cliente%TYPE, vemail IN CLIENTE.email_cliente%TYPE, vdoc IN CLIENTE.doc_cliente%TYPE)
